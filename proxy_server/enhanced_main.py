...
async def startup_event():
    ...
    try:
        ...
        from proxy_server.orchestrators.task_distributor import TaskDistributor
        ...
        from proxy_server.managers.multi_validator_manager import MultiValidatorManager
    ...
    try:
        ...
        task_data = {
            ...
            'input_file': {
                ...
                'file_size': len(file_data),
                'local_path': file_metadata['local_path'] if file_metadata else f"/proxy_server/local_storage/user_videos/{file_id}",
                'file_url': f"/api/v1/files/{file_id}",
                'checksum': str(hash(file_data)),  # Simple hash for now
                'uploaded_at': datetime.now()
            },
    ...
    try:
        ...
        task_data = {
            ...
            'input_file': {
                ...
                'file_size': len(file_data),
                'local_path': file_metadata['local_path'] if file_metadata else f"/proxy_server/local_storage/user_documents/{file_id}",
                'file_url': f"/api/v1/files/{file_id}",
                'checksum': str(hash(file_data)),  # Simple hash for now
                'uploaded_at': datetime.now()
            },
